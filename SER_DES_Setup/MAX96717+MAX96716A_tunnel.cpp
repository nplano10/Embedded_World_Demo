...
0x04,0x80,0x03,0x08,0x64, // FRONTTOP : FRONTTOP_0 | (Default) CLK_SELZ (CLK_SELZ): Port B | (Default) START_PORTB (START_PORTB): Enabled
...
0x04,0x80,0x02,0xBF,0xA0,
0x04,0x80,0x02,0xBE,0x00,
0x00,0x01,
